...
/** Hybrid (storage) inverter. The portal sends a command with the addressed device's own type. */
export const CLOUD_DEV_TYPE_STORAGE_INVERTER = 6;
...
/**
 * DTU reboot of a storage plant (station `classify` 4). The portal picks the code by plant class
 * (`classifyCheck(...).dtuReboot`: 27 for class 4, 1506 for the "Aurora" classes 10/11, 1 otherwise).
 */
export const DTU_COMMAND_REBOOT_STORAGE = 27;
