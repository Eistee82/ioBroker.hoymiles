...
const states = [
    ...
    { id: "grid.dailyEnergy", name: { en: "Daily energy", de: "Tagesenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "grid.totalEnergy", name: { en: "Total energy", de: "Gesamtenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    ...
    { id: "pv0.dailyEnergy", name: { en: "PV0 daily energy", de: "PV0 Tagesenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "pv0.totalEnergy", name: { en: "PV0 total energy", de: "PV0 Gesamtenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    ...
    { id: "pv1.dailyEnergy", name: { en: "PV1 daily energy", de: "PV1 Tagesenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "pv1.totalEnergy", name: { en: "PV1 total energy", de: "PV1 Gesamtenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    ...
    { id: "inverter.dtuDailyEnergy", name: { en: "DTU daily energy", de: "DTU Tagesenergie" }, type: "number", role: "value.energy", unit: "kWh" },
    ...
    { id: "cloud.todayEnergy", name: { en: "Today energy (cloud)", de: "Tagesenergie (Cloud)" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "cloud.monthEnergy", name: { en: "Month energy (cloud)", de: "Monatsenergie (Cloud)" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "cloud.yearEnergy", name: { en: "Year energy (cloud)", de: "Jahresenergie (Cloud)" }, type: "number", role: "value.energy", unit: "kWh" },
    { id: "cloud.totalEnergy", name: { en: "Total energy (cloud)", de: "Gesamtenergie (Cloud)" }, type: "number", role: "value.energy", unit: "kWh" },
